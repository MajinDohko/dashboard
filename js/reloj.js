...
fechaActual.classList.add('reloj');
...
} else if ((horas === 7 && minutos > 0) || (horas < 9) || (horas === 9 && minutos === 0)) {
    frases = "Prepárate, saca a la perra y tómate un café";
} else if ((horas === 9 && minutos > 0) || (horas < 12) || (horas === 12 && minutos === 0)) {
    frases = "Es hora de hacer código";
} else if ((horas === 12 && minutos > 0) || (horas < 14) || (horas === 14 && minutos === 0)) {
    frases = "Queda poco para el primer descanso, ¡ánimo!";
} else if ((horas === 14 && minutos > 0) || (horas < 16) || (horas === 16 && minutos === 0)) {
    frases = "Descansa, prepara algo de comer y coge energía";
} else if ((horas === 16 && minutos > 0) || (horas < 18) || (horas === 18 && minutos === 0)) {
    frases = "Buenas tardes, es hora del último empujón";
} else if ((horas === 18 && minutos > 0) || (horas < 21) || (horas === 21 && minutos === 0)) {
    frases = "Ya has hecho mucho por hoy, descansa y aprovecha la tarde.";
} else if ((horas === 21 && minutos > 0) || (horas < 23)) {
